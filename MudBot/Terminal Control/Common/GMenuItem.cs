...
{
    public abstract class GMenuItemBase : ToolStripMenuItem
    {
        protected int _id;
        ...
        {
            _shortcut = Keys.None;
            // RJC to convert to ToolStripMenuItem -- base.OwnerDraw = true;
        }
    ...
    public class GMenuItem : GMenuItemBase
    {
        ...
        //public override ToolStripMenuItem CloneMenu()
        //{
        ...
        //        e.ItemHeight = 7;
        //        e.ItemWidth = 16;
        //        // RJC to convert to ToolStripMenuItem -- Debug.Assert(this.OwnerDraw);
        //    }
        //    else
        //    {
        //        string miText = this.Text.Replace("&", "");
        ...
        private void DrawShortCutText(DrawItemEventArgs e)
        {
            ...
            {
                string shortcut_text = FormatShortcut(ShortcutKey);
