    ...
    internal class MacroUtil
    {
        public static Assembly LoadMacroAssembly(MacroModule mod)
        {
            ...
            else if (mod.Type == MacroType.JavaScript)
            {
                ...
                //    bld.Append("Message.MacroExec.FailedToCompileScript");
    ...
    internal class MacroExecutor
    {
        ...
        private void MacroMain()
        {
            ...
            catch (TargetInvocationException tex)
            {
                ...
                {
                    GApp.InterThreadUIService.Warning(String.Format("Message.MacroExec.ExceptionWithoutTraceWindow", inner.Message));
                ...
                {
                    _traceWindow.AddLine("Message.MacroExec.ExceptionInMacro");
